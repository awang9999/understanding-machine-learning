\message{ !name(understanding_machine_learning.tex)}\documentclass{article}
\usepackage{graphicx}
\usepackage{fullpage}
...
\message{ !name(understanding_machine_learning.tex) !offset(-3) }
...
\message{ !name(understanding_machine_learning.tex) !offset(-140) }
